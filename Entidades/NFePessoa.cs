...
namespace Nfe.Dominio.Entidades
{
    ...
    public class NFePessoa : Entidade
    {
        ...
        public  XmlElement toNfeXml(XmlDocument doc,int? tpAmb )
        {
            ...
            XmlElement indIDDest = doc.CreateElement("indIEDest");

            if (this.IE == null || this.IE.Trim() == "ISENTO")
                indIDDest.InnerText = "2"; //Indicador da IE do Destinatário 2 = Isento de contribuição;
            else
                indIDDest.InnerText = "1"; //Indicador da IE do Destinatário 1 = Contribuinte ICMS;
