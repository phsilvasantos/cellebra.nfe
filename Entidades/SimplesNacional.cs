...
namespace Nfe.Dominio.Entidades
{
    public class ItemSimplesNacional
    {
        ...
        public XmlElement toNfeXml(XmlDocument doc)
        {
            ...
            XmlElement pRedBCST = doc.CreateElement("pRedBCST"); pRedBCST.InnerText = this.pRedBCST.ToString().Replace(",", ".");
            ...
            XmlElement pRedBC = doc.CreateElement("pRedBC"); pRedBC.InnerText = this.pRedBC.ToString().Replace(",", ".");
