...
namespace Nfe.Infra
{
    public class ServicoXML
    {
        ...
        public void geraNotaEmXML()
        {
            ...
            //infNfe.AppendChild(getInfAdicionaisXml());
            infNfe.AppendChild(getInfPagXml());
        ...
        private XmlElement getInfPagXml()
        {
            XmlElement pag = doc.CreateElement("pag");
            XmlElement detPag = doc.CreateElement("detPag");
            XmlElement indPag = doc.CreateElement("indPag"); indPag.InnerText = Nota.indPag.ToString();
        ...
        private List<XmlElement> getTotalToXml( NotaFiscal nota)
        {
            ...
            XmlElement vICMSDeson = doc.CreateElement("vICMSDeson"); vICMSDeson.InnerText = "0.00";
            XmlElement vFCP = doc.CreateElement("vFCP"); vFCP.InnerText = "0.00";
            XmlElement vBCST = doc.CreateElement("vBCST"); vBCST.InnerText = "0.00";
            XmlElement vST = doc.CreateElement("vST"); vST.InnerText = nota.vST.Value.ToString("#0.00").Replace(',', '.');
            XmlElement vFCPST = doc.CreateElement("vFCPST"); vFCPST.InnerText = "0.00";
            XmlElement vFCPSTRet = doc.CreateElement("vFCPSTRet"); vFCPSTRet.InnerText = "0.00";
            ...
            XmlElement vIPIDevol = doc.CreateElement("vIPIDevol"); vIPIDevol.InnerText = "0.00";
        ...
        private List<XmlElement> getCobrancaToXml()
        {
            ...
            string numeroFatura = "001";
            //numeroFatura = numeroFatura.Substring(numeroFatura.Length - 3);

            XmlElement cobr = doc.CreateElement("cobr");
            XmlElement fat = doc.CreateElement("fat");
            XmlElement nFat = doc.CreateElement("nFat"); nFat.InnerText = numeroFatura;

            string vnf=Nota.vNF.Value.ToString("#0.00").Replace(',', '.');
            XmlElement vOrig = doc.CreateElement("vOrig"); vOrig.InnerText = vnf;
            string vDesconto = "0.00";
            XmlElement vDesc = doc.CreateElement("vDesc"); vDesc.InnerText = vDesconto;
