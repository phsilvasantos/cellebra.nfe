...
namespace Nfe.Infra
{
    public class AssinaturaDigital
    {
        ...
        public void Assinar(XmlDocument doc , string strUri, X509Certificate2 x509Certificado, string strArqXMLAssinado)
        {
        ...
        public void Assinar(XmlDocument doc, string strArqXMLAssinar, string strUri, X509Certificate2 x509Certificado)
        {
            try
            {
                this.Assinar(doc, strUri, x509Certificado, strArqXMLAssinar);
            }
            catch (Exception ex)
            {
                throw (ex);
