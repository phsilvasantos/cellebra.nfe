        ...
        public List<Produtos> getListaProdutosPorIdDaNota(int id, eTPNotaFiscal TipoNotaFiscal)
        {
            try
            {
                ...
                for (int i = 0;i < dtProdNotaFiscal.Rows.Count;i++)
                {
                    ...
                    {
                        prod.SimpNac = simples.getById(Convert.ToInt32(drProdNotaFiscal["id_produto"].ToString()), TipoNotaFiscal, drProdNotaFiscal["DescricaoTipoNota"].ToString());
                        prod.COFINS = cofins.getById(Convert.ToInt32(drProdNotaFiscal["id_produto"].ToString()), TipoNotaFiscal, drProdNotaFiscal["DescricaoTipoNota"].ToString());
                        prod.COFINSST = confinsST.getById(Convert.ToInt32(drProdNotaFiscal["id_produto"].ToString()), TipoNotaFiscal, drProdNotaFiscal["DescricaoTipoNota"].ToString());
                        prod.PIS = pis.getById(Convert.ToInt32(drProdNotaFiscal["id_produto"].ToString()), TipoNotaFiscal, drProdNotaFiscal["DescricaoTipoNota"].ToString());
                        prod.PISST = pisST.getById(Convert.ToInt32(drProdNotaFiscal["id_produto"].ToString()), TipoNotaFiscal, drProdNotaFiscal["DescricaoTipoNota"].ToString());
                    }
