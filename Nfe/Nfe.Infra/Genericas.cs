...
namespace Nfe.Infra
{
    ...
    public class Genericas
    {
        ...
        //    string strConexao = ConfigurationManager.ConnectionStrings["MultimaxConnectionString"].ConnectionString;
        ...
        public DataTable RetornaDTNotaFiscal(int id,eTPNotaFiscal TipoNotaFiscal)
        {
            ...
            //SqlDataAdapter daProdNotaFiscal = new SqlDataAdapter("SELECT * FROM vw_Danfe WHERE id_notafiscal = " + id.ToString(), conn);
